...
class EntityImageAdmin(admin.ModelAdmin):
    list_display=("original_name","entity_type","entity_id","source_schema","uploaded_by","uploaded_at","archived_by_deletion")
    readonly_fields=("checksum","exif_metadata","parsed_metadata","uploaded_at")
    def has_delete_permission(self,request,obj=None):
        if obj is not None and obj.archived_by_deletion_id:
            return False
